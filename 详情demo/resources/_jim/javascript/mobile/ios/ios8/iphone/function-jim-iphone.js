...
(function(window, undefined) {
	...
	function createKeyboard() {
		...
		$.each(iphone_kb, function(key, value) {
			if(jQuery("#jim-body.iphone5").length===0 || (jQuery("#jim-body.iphone5").length>0 && key != "url" && key != "email")) {
				html += ('<div id="' + key + '">');
				var kbname = key;
	...
	jQuery.extend(jimMobile, {
		...
		"resetWidgets": function() {
			...
			if(jQuery(input).closest(".number").find("input").length > 0) {
				jQuery("#jim-iphone-kb #letters").css('display', 'none');
				jQuery("#jim-iphone-kb #numbers").css('display', 'block');
				jQuery("#jim-iphone-kb #signs").css('display', 'none');
				jQuery("#jim-iphone-kb #email").css('display', 'none');
				jQuery("#jim-iphone-kb #url").css('display', 'none');
			}
			else if(jQuery(input).closest(".inputurl").find("input").length > 0 && jQuery("#jim-body.iphone5").length === 0) {
				jQuery("#jim-iphone-kb #letters").css('display', 'none');
				jQuery("#jim-iphone-kb #numbers").css('display', 'none');
				jQuery("#jim-iphone-kb #signs").css('display', 'none');
				jQuery("#jim-iphone-kb #email").css('display', 'none');
				jQuery("#jim-iphone-kb #url").css('display', 'block');
			}
			else if(jQuery(input).closest(".email").find("input").length > 0 && jQuery("#jim-body.iphone5").length === 0) {
				jQuery("#jim-iphone-kb #letters").css('display', 'none');
				jQuery("#jim-iphone-kb #numbers").css('display', 'none');
				jQuery("#jim-iphone-kb #signs").css('display', 'none');
				jQuery("#jim-iphone-kb #email").css('display', 'block');
				jQuery("#jim-iphone-kb #url").css('display', 'none');
			}
			else  {
